...
<div id="price_calculation_product_data" class="panel woocommerce_options_panel">
	...
	<?php
		...
		echo '<div id="message" class="updated inline rental-notice"><p><strong>'.sprintf(__('For More Pricing Plans & Others Amazing Features, Please Visit '.'<a href="%1$s" target="_blank"> ' . __( 'Premium Version', 'redq-rental' ) . '</a>'.' Of This Plugin. ', 'redq-rental'), $plugin_uri ).'</strong></p></div>';
